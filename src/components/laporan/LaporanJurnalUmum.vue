  ...
  <div>
    ...
    <modal :show="showModal" @close="showModal = false" addClass="modal-xl" modalOrientation="pt-20 lg:pt-6">
      ...
      <template v-slot:body>
        <div id="canvasDataJurnalUmum" class="bg-white rounded-sm overflow-y-auto">
          ...
          <div class="block text-center mb-4">
            <h2 class="font-medium uppercase">Laporan Jurnal Umum</h2>
...
export default {
  ...
  data() {
    return {
      ...
      printJurnalUmum: {
        id: "canvasDataJurnalUmum",
        popTitle: 'Laporan Jurnal Umum',
  ...
  methods: {
    ...
    toggleModal(props) {
      ...
      this.modalTitle = 'Laporan Jurnal Umum'
