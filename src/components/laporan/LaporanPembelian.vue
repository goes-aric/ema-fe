      ...
      <template v-slot:body>
        <div id="canvasDataPembelian" class="bg-white rounded-sm overflow-y-auto">
          ...
          <div class="block text-center mb-4">
            <h2 class="font-medium uppercase">Laporan Pembelian</h2>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th scope="col" class="bg-white text-gray-800 text-left">Kode Beli</th>
            ...
            <tbody>
              <template v-if="pembelian">
                ...
                <tr v-for="(item, index) in pembelian" :key="item.id">
                  ...
                  <td class="bg-white text-gray-800 border-gray-200 text-left">{{ item.kode_beli}}</td>
                ...
                <tr class="border-b border-gray-200 bg-gray-50">
                  <td class="bg-white text-gray-800 border-gray-200 text-left font-medium" colspan="5"><span class="font-medium">Total Pembelian</span></td>
